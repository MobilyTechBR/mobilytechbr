...
def custom_block_html(block: dict, prefix: str, links: dict[str, str], products, finalists) -> str:
    ...
    style = (
        ...
        f"--opacity:{max(0, min(100, custom_number(block.get('opacity'), 100))) / 100:.3f};"
...
def css() -> str:
    ...
    *{box-sizing:border-box}
    ...
    .custom-page{max-width:1540px;margin:auto;padding:34px 22px 46px}.custom-page-head{max-width:860px;margin:0 0 20px}.custom-page-head h1{font-size:clamp(32px,5vw,56px);line-height:1.02;margin:0 0 10px}.custom-page-head p{margin:0;color:#5f6874;font-weight:850;font-size:18px}.custom-stage{position:relative;min-height:680px;border:1px solid #dbe4ef;border-radius:24px;background:linear-gradient(135deg,#f8fbff,#fff);box-shadow:0 22px 70px rgba(13,23,38,.1);overflow:hidden}.custom-block{position:absolute;left:var(--x,8%);top:var(--y,12%);width:var(--w,260px);min-height:var(--h,80px);display:inline-flex;align-items:center;justify-content:center;padding:14px 18px;border-radius:var(--r,14px);background:var(--bg,#fff);color:var(--fg,#111);font-size:var(--fs,16px);font-weight:var(--fw,900);text-align:var(--ta,center);line-height:1.15;box-shadow:var(--shadow,none);text-shadow:var(--text-shadow,none);opacity:var(--opacity,1);z-index:var(--z,1);overflow:hidden;overflow-wrap:anywhere}.custom-block[data-bg-mode="gradient"]{background:linear-gradient(var(--angle,135deg),var(--g1,#fff),var(--g2,#e9f5ff))}.custom-block[data-bg-mode="glass"]{background:rgba(255,255,255,.34);border:1px solid rgba(255,255,255,.52);backdrop-filter:blur(var(--blur,12px));-webkit-backdrop-filter:blur(var(--blur,12px))}.custom-block[data-text-mode="gradient"],.custom-block[data-text-mode="texture"]{color:transparent;-webkit-background-clip:text;background-clip:text}.custom-block[data-text-mode="gradient"]{background-image:linear-gradient(var(--text-angle,90deg),var(--tg1,#111),var(--tg2,#148bff))}.custom-block[data-text-mode="texture"]{background-image:var(--text-texture);background-size:cover;background-position:center}.custom-block .text-texture-part{color:transparent;background-image:var(--text-texture);background-size:cover;background-position:center;-webkit-background-clip:text;background-clip:text}.custom-block[data-type="button"]{border-radius:var(--r,999px);min-height:var(--h,52px);padding:0 26px}.custom-block[data-type="text"]{background:transparent;box-shadow:none}.custom-block[data-type="image"]{padding:0;background:transparent;box-shadow:none}.custom-block[data-type="image"] img{width:100%;height:100%;object-fit:var(--fit,contain);display:block}.custom-block[data-type="line"]{min-height:0;height:var(--h,4px);padding:0;border:0;background:transparent;box-shadow:none}.custom-block[data-type="line"]:before{content:"";width:100%;height:max(2px,var(--h,4px));border-radius:999px;background:var(--bg,#148bff);box-shadow:var(--shadow,none)}.custom-block[data-type="icon"]{line-height:1}.custom-block[data-animation=fade]{animation:customFade var(--anim-duration,600ms) ease both}.custom-block[data-animation=rise]{animation:customRise var(--anim-duration,600ms) cubic-bezier(.2,.8,.2,1) both}.custom-block[data-animation=pop]{animation:customPop var(--anim-duration,520ms) cubic-bezier(.2,1.4,.2,1) both}.custom-block[data-animation=pulse]{animation:customPulse calc(var(--anim-duration,900ms) * 1.2) ease-in-out infinite}@keyframes customFade{from{opacity:0}to{opacity:var(--opacity,1)}}@keyframes customRise{from{opacity:0;transform:translateY(18px)}to{opacity:var(--opacity,1);transform:translateY(0)}}@keyframes customPop{from{opacity:0;transform:scale(.92)}to{opacity:var(--opacity,1);transform:scale(1)}}@keyframes customPulse{0%,100%{transform:scale(1)}50%{transform:scale(1.025)}}.custom-block:hover{filter:saturate(1.04)}
