...
const SITE_CONTENT_MAX_BODY_BYTES = 220 * 1024;
...
function cleanSiteContent(content) {
  ...
  const allowedTopLevel = new Set(["featureFlags", "homeHero", "homeFeaturedProducts", "servicePanels", "pages", "maintenance", "customPages"]);
  const cleaned = {};
